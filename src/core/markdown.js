 ...
 * 
 * Exposed via: window.OnePromptCore.markdown
 */
...
(function() {
  ...
  // Expose via window.OnePromptCore.markdown
  // Extend existing OnePromptCore if present, or create new
  window.OnePromptCore = window.OnePromptCore || {};
  window.OnePromptCore.markdown = {
    cleanAIResponseText,
    renderMarkdown,
    reCleanApiMessages
  };

  logger.log('[OnePrompt] Markdown module loaded');
